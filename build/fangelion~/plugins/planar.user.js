...
// @category       Info
// @version        0.2.5.362318
// @namespace      https://github.com/jonatkins/ingress-intel-total-conversion
// @updateURL      none
// @downloadURL    none
// @description    [fangelion-2016-06-15-201703] Display a sortable list of all visible portals with full details about the team, resonators, links, etc.
...
plugin_info.dateTimeVersion = '362318';
...
window.plugin.planar.eventLoad = function() {
  ...
  rowPl.droppable({
    ...
    over: function(ev, ui){ 
      ...
      rowIndex.css({backgroundColor: "#015801"});},
    out: function(ev, ui){ rowIndex.css({backgroundColor: "#017f01"});}
  });
  return true;
